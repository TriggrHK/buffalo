...
{
    public partial class buffaloContext : DbContext
    {
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseNpgsql("Host=localhost;Port=5432;Database=buffalo;Username=postgres;Password=");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Master>(entity =>
            {
                ...
                entity.Property(e => e.Structurefunction)
                    .HasColumnName("structurefunction")
                    .HasMaxLength(500);
